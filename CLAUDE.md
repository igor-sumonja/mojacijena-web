...
- Model naplate: **jedan godišnji iznos po paketu** (prva godina skuplja jer uključuje postavljanje, pa jeftinija obnova), os je „koliko posla radimo mi”. Nema više „uključenje + mjesečna pretplata”.
- **Besplatni plan se nudi** (premisa: besplatno je ručno zauvijek, plaćeno je automatski ili na vašoj domeni). Besplatni korisnik sam unosi cijene u portalu i sam preuzima XML/CSV/PDF; javni cjenik i QR su na mojacijena.hr, NE na klijentovoj domeni. Plaćeni paketi = automatska objava + cjenik i arhiva na klijentovoj domeni + postavljanje radimo mi. Upgrade je ručan: korisnik se javi, nakon uplate mu se podiže paket (samoregistracija i tiering su backend zadatak u cjenik-servisu). Dodatak „Promjene unosimo mi” (+100 €/god) je kvačica uz plaćeni paket, ne zaseban paket.
- Izrada ili preseljenje weba s ugrađenim cjenikom („Novi web + cjenik”) ravnopravan je plaćeni paket. Trgovina nije standardni paket: iznad stotinjak artikala ide individualna ponuda, bez istaknute cijene. Jamstvo povrata i bilo kakvi povrati novca ne nude se i ne spominju.
